...
class FinalBlindReadinessAuditTests(unittest.TestCase):
    def test_missing_external_inputs_block_without_opening_or_consuming(self):
        ...
        self.assertEqual(86, report["audited_candidate_count"])
        self.assertEqual(9, report["unaudited_reserve_count"])
        self.assertEqual(52, report["actual_qualified_case_count"])
