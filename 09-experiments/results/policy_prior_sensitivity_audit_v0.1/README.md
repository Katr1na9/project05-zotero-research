# Policy channel-prior sensitivity audit v0.1
...
AFA uses the frozen runtime allowlist. Depth-2 has tested hidden-outcome invariance but still requires a dedicated allowlist that permits declared `expected_effects`; this gap remains open and is not represented as complete.
