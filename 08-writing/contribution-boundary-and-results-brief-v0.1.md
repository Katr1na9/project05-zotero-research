...
- **不支持**：M3a 成本优于 M2；跨数据集泛化（C07 仅为一条 E5 THEIA trace；见 §3.4 C08）。
- 合规前快照曾为 M3a cost 4.3556 / regret 0.7111；过宽意图重标后成本上升，以本表与结果 README 为准。

### 3.4 C08 第二真留出（E5 ClearScope，公式冻结后）

| Planner | success | mean cost | mean regret vs Oracle |
|---|---:|---:|---:|
| Oracle | 1.0000 | 3.8889 | 0.0000 |
| M2 | 1.0000 | 4.5111 | 0.6222 |
| **M3a** | **1.0000** | **5.0444** | **1.1556** |
