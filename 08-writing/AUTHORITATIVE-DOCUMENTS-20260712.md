...
状态：论文 v0.4 保持为母本；C11 参数锁定补充评估已完成

## 1. 唯一写作入口

| 用途 | 当前权威文件 | 说明 |
|---|---|---|
| 论文主稿 | `paper-main-draft-v0.4-major-revision-20260711.md` | 仍是唯一论文母本；C11 尚未并入正文 |
...
| C11 数据接入协议 | `c11-otrf-apt29-day1-intake-protocol-v0.1-20260712.md` | 预注册 D1-D5、AND 多 claim、G3 上限和失败保留规则 |
...
2. C11 关闭了“第三种数据封装”和“真实可识别多 claim”两个工程缺口，但只增加一个 APT29 仿真链，不能声称广泛外部泛化。
