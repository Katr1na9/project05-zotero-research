...
## 6. C09 数据准备阶段允许的次级硬度（历史约束）

在当时等待 OpTC 下载期间，可在 **开发集 C01–C06** 上预登记并做：
...
- [x] 本机取得 GT PDF 并在事件读取前锁定 R06 窗口/主机
- [x] 下载 `AIA-201-225.ecar-last.json.gz` 并登记 SHA-256
- [x] 完成 eCAR 抽取脚本、motif 编译与事件级 UUID 回查
- [x] 完成 C09 案例编译与冻结评估；未调整 M3a
- [x] 更新 contribution brief 与 C07+C08+C09 paired regret 表
- [x] 2026-07-11 以精确 FQDN 重抽取；仍为 753,973 行且输出 SHA-256 不变
