...
状态：论文 v0.8 为唯一母本；C07-C11 双人盲标首轮已完成，当前等待第三人裁决与粒度独立性确认

## 1. 唯一写作入口

| 用途 | 当前权威文件 | 说明 |
|---|---|---|
| 论文主稿 | `paper-main-draft-v0.8-human-annotation-round1-20260713.md` | 唯一论文母本；新增 114 项 A/B 首轮人工一致性负结果 |
...
| 专利主稿 | `patent-main-draft-v0.7-zju-format-20260714.md` + `patent-package-v0.7-zju-format/` | 当前唯一专利母本；沿用 v0.6 的仅方法保护范围，并按浙大项目参考稿重排为摘要、权利要求书、说明书和说明书附图四部分 |
...
| 双人盲标首轮结果 | `human-annotation-round1-results-v0.1-20260713.md` + `../09-experiments/annotation/c07_c11_v0.2/` | 114/114 可比；Claim/Intent 未过门槛，校准等待 32 项裁决 |
...
11. 专利 v0.7 仅保护方法；系统、设备及存储介质权利要求保持删除状态。v0.7 只将 v0.6 内容重排为浙大项目参考稿的四部分格式；C12 两级来源 Gate 仍是可选实施例，FTR-010 在完成中国专利补检和代理师审查前不得升级为独立必要特征。
...
`AUTHORITATIVE-DOCUMENTS-20260711.md`、论文 v0.7、论文 v0.6 及更早稿、旧 reviewer/rigor review、早期 contribution brief、C07-C09 协议和早期 M3a 结果均保留为研究过程档案，不删除、不改写其阶段性事实，但不得继续承担当前状态索引或下一步计划的功能。

## 5. 当前未完成门槛

1. 由第三名标注者裁决 7 个 Claim 和 25 个 Intent 分歧；确认粒度文件独立性，无法确认时重新独立标注，再运行最终代理校准。
...
6. 专利 v0.7 已完成标准格式重排，但正式提交前仍须由代理师复核中国专利补检，确认 FTR-002 改写方案、权利要求 9 和 FTR-010 的处理，并完成权属、公开日、发明人/申请人确认和逐项审查。
