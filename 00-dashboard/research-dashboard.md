...
| G2 撞题扫描 | 进行中 | CLIProv/APT-CGLP 已升级全文精读；仍需补中文专利侧、TAA-EPLMR 复核、APT-ATT/APTChaser/GAPT 正文 |
...
2. 继续复核 TAA-EPLMR，并保留 APT-ATT、APTChaser、GAPT 正文获取待办；US12530469 仅作为摘要级专利红线保留。
