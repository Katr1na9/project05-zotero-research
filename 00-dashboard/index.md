...
- [论文 v0.6 C11 Policy Transfer](../08-writing/paper-main-draft-v0.6-c11-policy-transfer-20260713.md)
- [C11 增量复核](../08-writing/c11-increment-audit-v0.1-20260713.md)
...
- [C07-C11 人工标注协议 v0.2](../08-writing/human-annotation-evaluation-protocol-v0.2-20260712.md)
- [人工标注来源访问台账 v0.2](../08-writing/human-annotation-source-access-ledger-v0.2-20260713.md)
- [Claim 来源摘录包](../09-experiments/annotation/source_excerpts/c07_c11_v0.1/README.md)
- [Reviewer 回复矩阵 v0.2](../08-writing/reviewer-response-major-revision-v0.2-20260713.md)
- [修订后严谨性审计 v0.4](../08-writing/paper-main-rigor-review-v0.4-20260713.md)
...
- [科研进度](../04-progress/research-progress.md)
- [阅读路线图](../04-progress/reading-roadmap.md)
- [新颖性检查](../04-progress/novelty-checks.md)
- [复利日志](../05-logs/compound-learning-log.md)
- [踩坑日志](../05-logs/pitfall-log.md)
- [科研决策日志](../05-logs/decision-log.md)
...
```text
2025-Prasad-Cyber-Threat-Attribution-Survey.md
2022-Li-AttacKG.md
2021-Satvat-EXTRACTOR.md
2024-Cheng-KAIROS.md
2025-Lekssays-TechniqueRAG.md
```
...
6. `TechniqueRAG`
7. `CTIBench`
8. `Large Language Models are Unreliable for CTI`

## Codex 协作约定

之后你可以直接说：

- “按 project05 模板总结 AttacKG”
- “把这篇论文写入精读笔记”
- “更新 project05 进度”
- “把这个想法记到 idea 池”
- “根据当前文献更新选题矩阵”
