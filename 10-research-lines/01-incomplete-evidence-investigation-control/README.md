# P05-L1: Incomplete-Evidence Investigation Control

中文工作名称：不完整证据下、信息边界约束的 APT 调查控制。

这是 Project05 已推进的第一条论文线。为保护现有相对链接、冻结哈希和测试，当前文件仍保留在仓库根部的原 `00-09` 目录中；本目录提供统一入口和所有权边界。
