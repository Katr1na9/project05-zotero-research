...
$expectedBytes = 14897472844
$expectedMd5 = '1624d475a6bb337451f0ce201fb17456'
$downloadUrl = 'https://zenodo.org/api/records/3759652/files/eurosec2020-pandacap-rr.zip/content'
$curlPath = 'C:\WINDOWS\system32\curl.exe'
$rawRoot = Join-Path $PSScriptRoot 'local_audit_cache\pandacap-bounded-v0.1\raw'
$targetPath = Join-Path $rawRoot 'eurosec2020-pandacap-rr.zip'
...
[pscustomobject]@{
    target_id = 'pandacap_eurosec2020_rr_archive'
    target = $targetPath
